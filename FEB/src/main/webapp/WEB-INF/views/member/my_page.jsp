...
<div class="bd-cheatsheet container-fluid bg-body" style="max-width: 800px;">
<section id="components">
<article class="my-3" id="card">
<div>
<div class="bd-example">
<div class="row row-cols-sm-1 row-cols-md-1 row-cols-lg-1  g-4">
			    ...
			    <c:forEach var="i"  begin="0"  end="${postList.size()-1}" step="1">
				    ...
				    <div class="card">                                                                                                                                      
				      <form id="imageFrm${postList.get(i).getPostNo()}" name="imageFrm${postList.get(i).getPostNo()}" method="get">                                                                                                                                                                        
					     ...
					     <div class="thumb_nail_small_div" id="mainImageDiv${postList.get(i).getPostNo()}">                                                                                                                                                              
