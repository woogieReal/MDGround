	      ...
	      <div class="col-md-7 col-lg-8">
	        <form class="needs-validation" name="post_frm" id="post_frm" novalidate>
	          <div class="row g-3">
				...
				<input type="hidden" name="imageListDel" id="imageListDel" value='${imageList}'/>
				<input type="hidden" name="imageList" id="imageList" value=""/>
				<input type="hidden" name="postNo" id="postNo" value="${vo.postNo}"/>
	            ...
	            <div class="col-12">
	              ...
	              <input type="text" class="form-control" name="title" id="title" value="${vo.title}" placeholder="Please enter the title" required>
	            </div>
	            ...
	            <div class="col-12">
	              ...
	              <select class="form-select form-select-lg mb-3" id="category" style="font-size: medium;" aria-label=".form-select-lg example">
				  	...
				  	<option value="programming" <c:if test="${vo.category == 'programming'}">selected</c:if> >programming</option>                 
	          ...
	          <button class="w-100 btn btn-primary btn-lg" onclick="edit();" name="register_button" id="register_button" type="submit">Edit</button>
	      </div>
	    </div>
	  </main>
	</div>
